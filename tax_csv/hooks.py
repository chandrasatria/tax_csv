...
doc_events = {
	"Sales Invoice": {
		...
		"before_update_after_submit": ["tax_csv.tax_csv.doctype.custom_method_tax.check_faktur_pajak"],
	 	"validate": ["tax_csv.tax_csv.doctype.custom_method_tax.check_faktur_pajak"],
