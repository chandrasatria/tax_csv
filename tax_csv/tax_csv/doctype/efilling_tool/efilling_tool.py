		...
		if self.kategori == "Faktur Pajak Masukan" :
			...
			if(check==1) : 
				for a in self.get_data_retur_keluaran :
					if(a.check==1) :
						item_list4.append([str(a.rk),str(a.npwp),str(a.nik) + "#NIK#NAMA#" + str(a.nama),str(a.kd_jenis_transaksi),str(a.fg_pengganti),str(a.nomor_faktur),str(a.tanggal_faktur),str(a.no_dokumen_retur),str(a.tanggal_retur),str(a.masa_pajak_retur),str(a.tahun_pajak_retur),str(a.nilai_retur_dpp),str(a.nilai_retur_ppn),str(a.nilai_retur_ppnbm)])
